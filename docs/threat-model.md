...
- Hook overreach: hook does not custody player funds or settle winners.
...
- The hook is a local v4-compatible scaffold, not wired to canonical Uniswap v4 periphery imports.
